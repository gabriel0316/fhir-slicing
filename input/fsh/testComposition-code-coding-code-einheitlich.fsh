...
Parent: Composition
Description: "Example Composition 6"
Title: "Example Composition 6"
...
* section[Section3][+].code.coding[0].system = Canonical(ExampleCompositionSectionsCS)
* section[Section3][=].code.coding[=].code = #Section3
// * section[Section3][=].code.coding[+].system = "http://loinc.org"
// * section[Section3][=].code.coding[=].code = #2951-2
* section[Section3][=].text.status = #generated
* section[Section3][=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">test</div>"